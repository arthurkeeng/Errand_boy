    ...
    <div className="flex flex-col h-screen md:h-[600px] md:rounded-lg overflow-hidden shadow-lg bg-white/80 backdrop-blur-sm border border-brand-200">
      ...
      >
        ...
        <div className="flex items-center justify-center md:justify-start w-full md:w-auto">
          <h2 className="font-semibold text-lg">Errand Boy</h2>
        </div>
      ...
      >
        <div className="flex gap-2 min-w-max">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="relative text-white hover:bg-white/20 hover:text-white whitespace-nowrap flex-shrink-0"
            onClick={() => setShowOrders(true)}
          >
            <Package className="h-4 w-4 mr-2" />
            Orders
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {showHistory && (
          <div className="fixed inset-0 z-50 md:relative md:w-64 md:border-r bg-white">
            <div className="p-2 border-b bg-gradient-to-r from-brand-500 to-brand-600 text-white">
              <div className="flex justify-between items-center">
                <h3 className="font-medium">Conversations</h3>
                <div className="flex gap-1">
